...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer_interaction.create': {
    roles: ['admin-user', 'backend-developer', 'frontend-developer'],
    key: 'new-customer-interaction',
    tenantPath: ['organization', 'user', 'customer_interaction'],
    userPath: [],
  },
  'api_key.update': {
    roles: ['admin-user', 'backend-developer'],
    key: 'api-key-updated',
    tenantPath: ['organization', 'user', 'api_key'],
    userPath: [],
  },
  'user_activity.create': {
    roles: ['admin-user'],
    key: 'developer-left-organization',
    tenantPath: ['organization', 'user', 'user_activity'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin-user', 'backend-developer', 'frontend-developer'];
