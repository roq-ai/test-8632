  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the power of communication with Test - your innovative chat GPT prompt generator tool. Store your API key, run prompts, and redefine interactions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1675865254433-6ba341f0f00b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0Ym90fGVufDB8fHx8MTY5NDAxODI3N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the power of communication with Test - your innovative chat GPT prompt generator tool. Store your API key, run prompts, and redefine interactions.`}
            </Text>
            <Box
