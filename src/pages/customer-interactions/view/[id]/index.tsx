...
import { getCustomerInteractionById } from 'apiSdk/customer-interactions';
import { CustomerInteractionInterface } from 'interfaces/customer-interaction';

function CustomerInteractionViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Customer Interaction Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('customer_interaction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/customer-interactions/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Interaction Result" text={data?.interaction_result} />
