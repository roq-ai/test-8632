...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin-user', 'backend-developer', 'frontend-developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Api Keys', path: '/api-keys', entity: 'api_key', service: AccessServiceEnum.PROJECT, icon: FiKey },
    {
      name: 'Chat Gpt Prompts',
      path: '/chat-gpt-prompts',
